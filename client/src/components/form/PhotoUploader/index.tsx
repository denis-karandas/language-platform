...
const PhotoUploader = ({
  ...
  alt = 'Photo'
    ...
    const [photoUrl, setPhotoUrl] = React.useState<string | null>(defaultPhotoUrl);
    ...
    }, [getErrorByType, setValue, setError]);
    ...
    const renderInitialContainer = () => (
      <div className={cn(styles.initialContainer, { [styles.blur]: isBlurOnInitialContainer })}>
        <div className={styles.imageFrame}>
          <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M30 26.6667V3.33333C30 1.5 28.5 0 26.6667 0H3.33333C1.5 0 0 1.5 0 3.33333V26.6667C0 28.5 1.5 30 3.33333 30H26.6667C28.5 30 30 28.5 30 26.6667ZM9.16667 17.5L13.3333 22.5167L19.1667 15L26.6667 25H3.33333L9.16667 17.5Z" fill="#379CF9"/></svg>
        </div>
